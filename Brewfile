...
cask "font-cascadia-mono" # Version of Cascadia Code without ligatures -- https://github.com/microsoft/cascadia-code
cask "font-cascadia-mono-nf" # Version of Cascadia Code without ligatures and with embedded Nerd Fonts symbols -- https://github.com/microsoft/cascadia-code
cask "font-cascadia-mono-pl" # Version of Cascadia Code without ligatures and with embedded Powerline symbols -- https://github.com/microsoft/cascadia-code
cask "font-dejavu" # Monospaced font based on Bitstream Vera -- https://sourceforge.net/projects/dejavu/
cask "font-fira-code" # Monospaced font with programming ligatures -- https://github.com/tonsky/FiraCode
cask "font-fira-sans" # Font used in Firefox OS -- https://mozilla.github.io/Fira/
cask "font-firago" # Successor to Fira Sans -- https://bboxtype.com/typefaces/FiraGO/
cask "font-ibm-plex" # Corporate typeface for IBM -- https://github.com/IBM/plex
cask "font-inconsolata" # Humanist lineal monospaced font -- https://fonts.google.com/specimen/Inconsolata
cask "font-iosevka" # Sans-serif, slab-serif, monospace and quasi‑proportional typeface family -- https://github.com/be5invis/Iosevka
cask "font-jetbrains-mono" # Typeface made for developers -- https://www.jetbrains.com/lp/mono
cask "font-juliamono" # Monospaced typeface designed for programming in Julia -- https://github.com/cormullion/juliamono
cask "font-roboto" # Font with a mechanical skeleton and the forms are largely geometric -- https://fonts.google.com/specimen/Roboto
cask "font-roboto-condensed" # Condensed variant of Roboto -- https://fonts.google.com/specimen/Roboto+Condensed
cask "font-roboto-flex" # Variable successor to Roboto -- https://fonts.google.com/specimen/Roboto+Condensed
cask "font-roboto-mono" # Monospaced variant of Roboto -- https://fonts.google.com/specimen/Roboto+Mono
cask "font-roboto-slab" # Slab variant of Roboto -- https://fonts.google.com/specimen/Roboto+Slab
cask "font-sf-mono" # Monospaced variant of "San Francisco" by Apple -- https://developer.apple.com/fonts/
cask "font-sf-pro" # Sans-serif variant of "San Francisco" by Apple -- https://developer.apple.com/fonts/
...
# Audio casks
cask "foobar2000" # Audio player -- https://www.foobar2000.org/mac
cask "musicbrainz-picard" # Music tagger -- https://picard.musicbrainz.org/

# Image apps
brew "exiftool" # Perl lib for reading and writing EXIF metadata -- https://exiftool.org/
...
# Video casks
cask "handbrake" # Open-source video transcoder -- https://handbrake.fr/
cask "vlc" # Multimedia player -- https://www.videolan.org/vlc/
# Video MAS apps
mas "DaVinci Resolve", id: 571_213_070 # https://www.blackmagicdesign.com/products/davinciresolve
...
brew "ctop" # Top-like interface for container metrics -- https://bcicen.github.io/ctop/
brew "curl" # Get a file from an HTTP, HTTPS or FTP server -- https://curl.se
brew "dos2unix" # Convert text between DOS, UNIX, and Mac formats -- https://waterlan.home.xs4all.nl/dos2unix.html
brew "dust" # More intuitive version of du in rust -- https://github.com/bootandy/dust
brew "entr" # Run arbitrary commands when files change -- https://eradman.com/entrproject/
brew "fastfetch" # Like neofetch, but much faster because written mostly in C -- https://github.com/fastfetch-cli/fastfetch
brew "fd" # Simple, fast and user-friendly alternative to find -- https://github.com/sharkdp/fd
brew "figlet" # Banner-like program prints strings as ASCII art -- http://www.figlet.org/
...
brew "gdu" # Disk usage analyzer with console interface written in Go -- https://github.com/dundee/gdu
...
brew "llvm" # Next-gen compiler infrastructure -- https://llvm.org/
brew "lnav" # Curses-based tool for viewing and analyzing log files -- https://lnav.org/
...
brew "nmap" # Port scanning utility for large networks -- https://nmap.org/
brew "nnn" # Tiny, lightning fast, feature-packed file manager -- https://github.com/jarun/nnn
brew "no-more-secrets" # Recreates the SETEC ASTRONOMY effect from 'Sneakers' -- https://github.com/bartobri/no-more-secrets
brew "ollama" # Create, run, and share large language models -- https://ollama.com/
brew "openssl" # Cryptography and SSL/TLS Toolkit -- https://openssl.org/
brew "pandoc" # Swiss-army knife of markup format conversion -- https://pandoc.org/
brew "parallel" # Shell command parallelization utility -- https://savannah.gnu.org/projects/parallel/
brew "pkg-config" # Manage compile and link flags for libraries -- https://freedesktop.org/wiki/Software/pkg-config/
brew "procs" # Modern replacement for ps written by Rust -- https://github.com/dalance/procs
brew "qrencode" # QR Code generation -- https://fukuchi.org/works/qrencode/index.html.en
brew "readline" # Library for command-line editing -- https://tiswww.case.edu/php/chet/readline/rltop.html
brew "rename" # Perl-powered file rename script with many helpful built-ins -- http://plasmasturm.org/code/rename
brew "ripgrep" # Search tool like grep and The Silver Searcher -- https://github.com/BurntSushi/ripgrep
...
brew "telnet" # User interface to the TELNET protocol -- https://opensource.apple.com/
brew "tmux" # Terminal multiplexer -- https://tmux.github.io/
brew "tokei" # Program that allows you to count code, quickly -- https://github.com/XAMPPRocky/tokei
...
brew "tree-sitter" # Parser generator tool and incremental parsing library -- https://tree-sitter.github.io/
brew "utm" # Virtual machines UI using QEMU -- https://mac.getutm.app/
...
cask "godot" # Game development engine -- https://godotengine.org/
#cask "ldtk" # 2D level editor -- https://ldtk.io
cask "love" # 2D game framework for Lua -- https://love2d.org/
